...
public class FifteenPercentDiscountTest {
    @Test
    void shouldApply15PercentDiscountWhenHas3OrMoreGrainProducts() {
        // Given
        ...
        var expectedTotalPrice = bread.price().multiply(BigDecimal.valueOf(5)).add(cereals.price()).multiply(BigDecimal.valueOf(0.85));
        // When
        var receiptAfterDiscount = discount.apply(receipt);
        System.out.println(receiptAfterDiscount.totalPrice());
    ...
    @Test
    void shouldNotApply15PercentDiscountWhenHasnt3OrMoreGrainProducts() {
        // Given
        var productDb = new ProductDb();
